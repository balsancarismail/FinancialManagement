...
public class CreateAuthenticationTokenCommand(string email, string password, string ipAddress)
    : IRequest<CreatedAuthenticationTokenResponse>, ILoggableRequest
{
    public string Email { get; set; } = email;
    public string Password { get; set; } = password;

    [JsonIgnore] public string? IpAddress { get; set; } = ipAddress;

    public class
        CreateAuthenticationTokenCommandHandler(
        ...
        : IRequestHandler<CreateAuthenticationTokenCommand, CreatedAuthenticationTokenResponse>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (!isPasswordValid) throw new AuthorizationException(AuthMessages.PasswordDontMatch);
