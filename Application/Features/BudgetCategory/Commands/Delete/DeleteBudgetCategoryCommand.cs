...
/// </summary>
public class DeleteBudgetCategoryCommand : IRequest<DeleteBudgetCategoryResponse>, ICacheRemoverRequest, ISecuredRequest, ITransactionalRequest, ILoggableRequest
{
    [JsonIgnore]
        ...
        : IRequestHandler<DeleteBudgetCategoryCommand, DeleteBudgetCategoryResponse>
    {
        ...
        public async Task<DeleteBudgetCategoryResponse> Handle(DeleteBudgetCategoryCommand request, CancellationToken cancellationToken)
        {
